...
parseText format ["<t shadow='1' shadowColor='#000000' color='#FFFFFF'>Score : %1 points <t color='#cd8700'>|</t> Undercover : <t color='%2'>%3</t> <t color='#cd8700'>|</t> Reputation : %4/100</t>",_points,_colorUnd,_statusUnd,STAT_SUPPORT];
