...
for "_xc" from 1 to _nbAircrafts do {
    _spawnPos = [(([] call JP_fnc_allPlayers) call BIS_fnc_selectRandom) , 4000, 10500, 3, 0, 20, 0,MARKER_WHITE_LIST] call BIS_fnc_findSafePos;
    ...
    [_aircraft] call JP_fnc_aircraftPatrol;
    sleep 10;
};
AIRCRAFTS;