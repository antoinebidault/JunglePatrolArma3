...
for "_xc" from 1 to NUMBER_CHOPPERS do {
    _spawnPos = [(([] call JP_fnc_allPlayers) call BIS_fnc_selectRandom) , 4000, 4500, 3, 0, 20, 0,MARKER_WHITE_LIST] call BIS_fnc_findSafePos;
    ...
    [_chopper] call JP_fnc_chopperpatrol;
